...
import 'package:igloo/Create_and_Post/my_profile_details.dart';
...
import '../HowToUse/Youtube_Player.dart';
    ...
    return FirebaseFirestore.instance
      ...
      for (var doc in snapshot.docs) {
        ...
        if (votes != null && votes.containsKey(userId)) {
          totalVotes += votes[userId] == true ? 1 : 0; // Increment for upvote
        }
      }
                    ...
                    child: StreamBuilder<int>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Column(
                          ...
                          children: [
                            Text("Your Cred",style: TextStyle(fontSize: 25.sp,fontWeight: FontWeight.bold   ),),
                            Text(
                              "$totalVotes", // Display the total votes gained
                              style: TextStyle(fontSize: 39.sp,color: const Color(0xFF27D4C1),fontWeight: FontWeight.bold),
                            ),
                          ],
                        );
                      },
                ...
                child: Card(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          SvgPicture.asset('res/images/shareButtonProfileScreeen.svg',width: 35.w,height: 35.h,),
                          SizedBox(width: 20.w,),
                          Padding(
                              padding: EdgeInsets.only(top: 5.h),
                              child: Text('Share To Unique Link',style: TextStyle(fontSize: 20.sp,fontWeight:FontWeight.bold),)),
                          const Spacer(),
                           Icon(Icons.arrow_forward_ios_rounded,size: 35.sp,)
                        ],
                      ),
                    )),
                onTap: (){
